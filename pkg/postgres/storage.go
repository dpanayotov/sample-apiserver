...
func NewPostgresStorage() factory.StorageFactoryFunc {
	return func(c storagebackend.Config) (storage.Interface, factory.DestroyFunc, error) {
...
func NewPostgresHealthCheck() factory.StorageHealthCheckFunc {
	return func(c storagebackend.Config) (func() error, error) {
		return func() error {
			return nil
		}, nil
	}
